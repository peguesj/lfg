...
CACHES=(
    ...
    "APP|Microsoft EdgeUpdater|$HOME/Library/Application Support/Microsoft/EdgeUpdater|"
    "AI|Claude vm_bundles|$HOME/Library/Application Support/Claude/vm_bundles|"
    "AI|Chrome ML models|$HOME/Library/Application Support/Google/Chrome/OptimizationGuidePredictionModels|"
    "AI|Chrome OptGuide hints|$HOME/Library/Application Support/Google/Chrome/OptimizationHints|"
    "AI|Ollama models|$HOME/.ollama/models|"

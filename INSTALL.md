...
Note: The plist files in the repo use `/Users/jeremiah/tools/@yj/lfg` as the base path. If your install path differs, update `ProgramArguments` and `EnvironmentVariables` accordingly.

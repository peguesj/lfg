...
const LFG = {
  ...
  _modules: [
    ...
    { id: 'ssd',      label: 'SSD',      key: '6', icon: '<svg viewBox="0 0 24 24" width="20" height="20"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><line x1="8" y1="12" x2="16" y2="12"/></svg>' },
  ],

  _utilModules: [
    { id: 'chat',     label: 'Chat',     key: '7', icon: '<svg viewBox="0 0 24 24" width="20" height="20"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>' },
  ...
  chat: {
    ...
    _agentColors: {
      ...
      btau: '#06d6a0', devdrive: '#c084fc', stfu: '#e879f9', ssd: '#facc15'
    },

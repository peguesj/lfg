...
def mod_summary(name):
    ...
    if name == "wtfs":
        ...
        return m.get("mds_cpu", "--"), m.get("indexed_count", "--"), status
    return "--", "--", status
...
tooltip_ssd = f"Slows Sh*t Down -- mds CPU: {ssd[0]}, {ssd[1]} indexed volumes"
...
LFG.init({{
  context: "Home",
  moduleVersion: "2.4.0",
  helpContent: "<strong>LFG Home</strong><br><br>Navigate modules using the <strong>nav pills</strong> in the header bar, or use keyboard shortcuts:<br><br><code>&#8984;1</code> WTFS &mdash; Disk usage analysis<br><code>&#8984;2</code> DTF &mdash; Cache cleanup<br><code>&#8984;3</code> BTAU &mdash; Backup manager<br><code>&#8984;4</code> DEVDRIVE &mdash; Developer drive<br><code>&#8984;5</code> STFU &mdash; Source tree forensics<br><code>&#8984;6</code> SSD &mdash; Spotlight manager<br><code>&#8984;7</code> Chat &mdash; AI chat<br><code>&#8984;D</code> Dashboard &mdash; Combined view<br><br>Press <code>?</code> anytime to open this help."
}});
